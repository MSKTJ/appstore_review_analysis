...
router.post('/problems', async (req, res) => {
  try {
    ...
    console.log(`Generating problem analysis for app ${appId}`);
    ...
    const analyzedReviews = cachedData.data.reviews;
    ...
    // 問題分析を実行
    const problemAnalysis = await geminiService.generateProblemAnalysis(analyzedReviews);
